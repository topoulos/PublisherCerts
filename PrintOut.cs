...
namespace PublisherCerts2
{
    public static class PrintOut
    {
        ...
        public static void PrintMember(ref Document doc, vwCertificate certificate)
        {
            ...
            stDateFrame.TextRange.Text = Convert.ToDateTime(certificate.FromDate).ToString(dateFormatString);
            ...
            edDateFrame.TextRange.Text = Convert.ToDateTime(certificate.ThruDate).ToString(dateFormatString);
